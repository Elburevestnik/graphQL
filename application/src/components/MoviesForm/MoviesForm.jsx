...
class MoviesForm extends React.Component {
  ...
  handleSave = () => {
    ...
    id ? updateMovie({id, name, genre, rate: Number(rate), directorId: directorId, watched: Boolean(watched)}) : addMovie({name, genre, rate: Number(rate), directorId: directorId, watched: Boolean(watched)});
    onClose();
  };
